 ...
 * Page class
 */
class ck_danhmuc_thietbi_grid extends ck_danhmuc_thietbi
{
	...
	// Page object name
	public $PageObjName = "ck_danhmuc_thietbi_grid";

	// Grid form hidden field names
	public $FormName = "fck_danhmuc_thietbigrid";
	...
	public function __construct()
	{
		...
		$this->AddUrl = "ck_danhmuc_thietbiadd.php";
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	{
		global $CurrentForm;
		if ($CurrentForm->hasValue("x_chung_loai_id") && $CurrentForm->hasValue("o_chung_loai_id") && $this->chung_loai_id->CurrentValue != $this->chung_loai_id->OldValue)
			return FALSE;
		if ($CurrentForm->hasValue("x_ky_ma_hieu") && $CurrentForm->hasValue("o_ky_ma_hieu") && $this->ky_ma_hieu->CurrentValue != $this->ky_ma_hieu->OldValue)
			return FALSE;
		if ($CurrentForm->hasValue("x_bo_phan") && $CurrentForm->hasValue("o_bo_phan") && $this->bo_phan->CurrentValue != $this->bo_phan->OldValue)
			return FALSE;
		if ($CurrentForm->hasValue("x_namsx") && $CurrentForm->hasValue("o_namsx") && $this->namsx->CurrentValue != $this->namsx->OldValue)
			return FALSE;
		if ($CurrentForm->hasValue("x_ghi_chu") && $CurrentForm->hasValue("o_ghi_chu") && $this->ghi_chu->CurrentValue != $this->ghi_chu->OldValue)
			return FALSE;
		return TRUE;
	}
	...
	protected function loadFormValues()
	{
		...
		if ($CurrentForm->hasValue("o_chung_loai_id"))
			$this->chung_loai_id->setOldValue($CurrentForm->getValue("o_chung_loai_id"));
		...
		if ($CurrentForm->hasValue("o_ky_ma_hieu"))
			$this->ky_ma_hieu->setOldValue($CurrentForm->getValue("o_ky_ma_hieu"));
		...
		if ($CurrentForm->hasValue("o_bo_phan"))
			$this->bo_phan->setOldValue($CurrentForm->getValue("o_bo_phan"));
		...
		if ($CurrentForm->hasValue("o_namsx"))
			$this->namsx->setOldValue($CurrentForm->getValue("o_namsx"));
		...
		if ($CurrentForm->hasValue("o_ghi_chu"))
			$this->ghi_chu->setOldValue($CurrentForm->getValue("o_ghi_chu"));
	...
	protected function setupMasterParms()
	{
		...
		if ($masterTblVar == "ck_chungloai_thietbi") {
			...
			if ($GLOBALS["ck_chungloai_thietbi"]->EventCancelled)
