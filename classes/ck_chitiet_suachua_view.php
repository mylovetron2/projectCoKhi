 ...
 * Page class
 */
class ck_chitiet_suachua_view extends ck_chitiet_suachua
{
	...
	// Page object name
	public $PageObjName = "ck_chitiet_suachua_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "ck_chitiet_suachualist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "ck_chitiet_suachualist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "ck_chitiet_suachualist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
