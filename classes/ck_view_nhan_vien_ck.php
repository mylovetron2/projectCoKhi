...
/**
 * Table class for ck_view_nhan_vien_ck
 */
class ck_view_nhan_vien_ck extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'ck_view_nhan_vien_ck';
		$this->TableName = 'ck_view_nhan_vien_ck';
		$this->TableType = 'VIEW';

		// Update Table
		$this->UpdateTable = "`ck_view_nhan_vien_ck`";
		$this->Dbid = 'DB';
		$this->ExportAll = TRUE;
		...
		// danh_so
		$this->danh_so = new DbField('ck_view_nhan_vien_ck', 'ck_view_nhan_vien_ck', 'x_danh_so', 'danh_so', '`danh_so`', '`danh_so`', 3, 11, -1, FALSE, '`danh_so`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ten_nhan_vien
		$this->ten_nhan_vien = new DbField('ck_view_nhan_vien_ck', 'ck_view_nhan_vien_ck', 'x_ten_nhan_vien', 'ten_nhan_vien', '`ten_nhan_vien`', '`ten_nhan_vien`', 200, 50, -1, FALSE, '`ten_nhan_vien`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// chuc_danh
		$this->chuc_danh = new DbField('ck_view_nhan_vien_ck', 'ck_view_nhan_vien_ck', 'x_chuc_danh', 'chuc_danh', '`chuc_danh`', '`chuc_danh`', 200, 50, -1, FALSE, '`chuc_danh`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->chuc_danh->Sortable = TRUE; // Allow sort
		$this->fields['chuc_danh'] = &$this->chuc_danh;

		// nhan_vien_id
		$this->nhan_vien_id = new DbField('ck_view_nhan_vien_ck', 'ck_view_nhan_vien_ck', 'x_nhan_vien_id', 'nhan_vien_id', '`nhan_vien_id`', '`nhan_vien_id`', 3, 11, -1, FALSE, '`nhan_vien_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// nhom_nhan_vien_id
		$this->nhom_nhan_vien_id = new DbField('ck_view_nhan_vien_ck', 'ck_view_nhan_vien_ck', 'x_nhom_nhan_vien_id', 'nhom_nhan_vien_id', '`nhom_nhan_vien_id`', '`nhom_nhan_vien_id`', 3, 11, -1, FALSE, '`nhom_nhan_vien_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->nhom_nhan_vien_id->Nullable = FALSE; // NOT NULL field
		$this->nhom_nhan_vien_id->Required = TRUE; // Required field
	...
	{
		return ($this->SqlFrom != "") ? $this->SqlFrom : "`ck_view_nhan_vien_ck`";
	}
	...
	public function getReturnUrl()
	{
		...
		if (@$_SESSION[$name] != "") {
			...
			return "ck_view_nhan_vien_cklist.php";
		}
	}
	...
	{
		global $Language;
		if ($pageName == "ck_view_nhan_vien_ckview.php")
			return $Language->phrase("View");
		elseif ($pageName == "ck_view_nhan_vien_ckedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "ck_view_nhan_vien_ckadd.php")
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("ck_view_nhan_vien_ckview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("ck_view_nhan_vien_ckview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "ck_view_nhan_vien_ckadd.php?" . $this->getUrlParm($parm);
		else
			$url = "ck_view_nhan_vien_ckadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("ck_view_nhan_vien_ckedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("ck_view_nhan_vien_ckadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("ck_view_nhan_vien_ckdelete.php", $this->getUrlParm());
	}
	...
	public function renderListRow()
	{
		...
		$this->nhom_nhan_vien_id->ViewValue = FormatNumber($this->nhom_nhan_vien_id->ViewValue, 0, -2, -2, -2);
	...
	public function renderEditRow()
	{
		...
		$this->nhom_nhan_vien_id->PlaceHolder = RemoveHtml($this->nhom_nhan_vien_id->caption());
