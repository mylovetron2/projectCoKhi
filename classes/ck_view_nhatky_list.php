 ...
 * Page class
 */
class ck_view_nhatky_list extends ck_view_nhatky
{
	...
	// Table name
	public $TableName = 'ck_view_nhatky';

	// Page object name
	public $PageObjName = "ck_view_nhatky_list";

	// Grid form hidden field names
	public $FormName = "fck_view_nhatkylist";
	...
	public function __construct()
	{
		...
		// Table object (ck_view_nhatky)
		if (!isset($GLOBALS["ck_view_nhatky"]) || get_class($GLOBALS["ck_view_nhatky"]) == PROJECT_NAMESPACE . "ck_view_nhatky") {
			$GLOBALS["ck_view_nhatky"] = &$this;
			$GLOBALS["Table"] = &$GLOBALS["ck_view_nhatky"];
		}
		...
		$this->AddUrl = "ck_view_nhatkyadd.php";
		$this->InlineAddUrl = $this->pageUrl() . "action=add";
		$this->GridAddUrl = $this->pageUrl() . "action=gridadd";
		$this->GridEditUrl = $this->pageUrl() . "action=gridedit";
		$this->MultiDeleteUrl = "ck_view_nhatkydelete.php";
		$this->MultiUpdateUrl = "ck_view_nhatkyupdate.php";
		...
		if (!defined(PROJECT_NAMESPACE . "TABLE_NAME"))
			define(PROJECT_NAMESPACE . "TABLE_NAME", 'ck_view_nhatky');
		...
		$this->FilterOptions->TagClassName = "ew-filter-option fck_view_nhatkylistsrch";
	...
	public function getFilterList()
	{
		...
		$filterList = Concat($filterList, $this->thoi_gian->AdvancedSearch->toJson(), ","); // Field thoi_gian
		$filterList = Concat($filterList, $this->noi_dung->AdvancedSearch->toJson(), ","); // Field noi_dung
		...
		$filterList = Concat($filterList, $this->so_don_hang_id->AdvancedSearch->toJson(), ","); // Field so_don_hang_id
		$filterList = Concat($filterList, $this->ngay_hoan_thanh->AdvancedSearch->toJson(), ","); // Field ngay_hoan_thanh
		$filterList = Concat($filterList, $this->baoduong_dinhky->AdvancedSearch->toJson(), ","); // Field baoduong_dinhky
	...
	protected function processFilterList()
	{
		...
		if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
			...
			$UserProfile->setSearchFilters(CurrentUserName(), "fck_view_nhatkylistsrch", $filters);
	...
	protected function restoreFilterList()
	{
		...
		// Field thoi_gian
		$this->thoi_gian->AdvancedSearch->SearchValue = @$filter["x_thoi_gian"];
		$this->thoi_gian->AdvancedSearch->SearchOperator = @$filter["z_thoi_gian"];
		$this->thoi_gian->AdvancedSearch->SearchCondition = @$filter["v_thoi_gian"];
		$this->thoi_gian->AdvancedSearch->SearchValue2 = @$filter["y_thoi_gian"];
		$this->thoi_gian->AdvancedSearch->SearchOperator2 = @$filter["w_thoi_gian"];
		$this->thoi_gian->AdvancedSearch->save();

		// Field noi_dung
		$this->noi_dung->AdvancedSearch->SearchValue = @$filter["x_noi_dung"];
		$this->noi_dung->AdvancedSearch->SearchOperator = @$filter["z_noi_dung"];
		$this->noi_dung->AdvancedSearch->SearchCondition = @$filter["v_noi_dung"];
		$this->noi_dung->AdvancedSearch->SearchValue2 = @$filter["y_noi_dung"];
		$this->noi_dung->AdvancedSearch->SearchOperator2 = @$filter["w_noi_dung"];
		$this->noi_dung->AdvancedSearch->save();
		...
		$this->so_don_hang_id->AdvancedSearch->SearchValue = @$filter["x_so_don_hang_id"];
		$this->so_don_hang_id->AdvancedSearch->SearchOperator = @$filter["z_so_don_hang_id"];
		$this->so_don_hang_id->AdvancedSearch->SearchCondition = @$filter["v_so_don_hang_id"];
		$this->so_don_hang_id->AdvancedSearch->SearchValue2 = @$filter["y_so_don_hang_id"];
		$this->so_don_hang_id->AdvancedSearch->SearchOperator2 = @$filter["w_so_don_hang_id"];
		...
		$this->baoduong_dinhky->AdvancedSearch->SearchValue = @$filter["x_baoduong_dinhky"];
		$this->baoduong_dinhky->AdvancedSearch->SearchOperator = @$filter["z_baoduong_dinhky"];
		$this->baoduong_dinhky->AdvancedSearch->SearchCondition = @$filter["v_baoduong_dinhky"];
		$this->baoduong_dinhky->AdvancedSearch->SearchValue2 = @$filter["y_baoduong_dinhky"];
		$this->baoduong_dinhky->AdvancedSearch->SearchOperator2 = @$filter["w_baoduong_dinhky"];
	...
	protected function advancedSearchWhere($default = FALSE)
	{
		...
		if (!$Security->canSearch())
			return "";
		$this->buildSearchSql($where, $this->nhan_vien_id, $default, FALSE); // nhan_vien_id
		$this->buildSearchSql($where, $this->ngay_sua_chua, $default, FALSE); // ngay_sua_chua
		$this->buildSearchSql($where, $this->thoi_gian, $default, FALSE); // thoi_gian
		$this->buildSearchSql($where, $this->noi_dung, $default, FALSE); // noi_dung
		...
		$this->buildSearchSql($where, $this->so_don_hang_id, $default, FALSE); // so_don_hang_id
		$this->buildSearchSql($where, $this->ngay_hoan_thanh, $default, FALSE); // ngay_hoan_thanh
		$this->buildSearchSql($where, $this->baoduong_dinhky, $default, FALSE); // baoduong_dinhky
		...
		if (!$default && $this->Command == "search") {
			$this->nhan_vien_id->AdvancedSearch->save(); // nhan_vien_id
			$this->ngay_sua_chua->AdvancedSearch->save(); // ngay_sua_chua
			$this->thoi_gian->AdvancedSearch->save(); // thoi_gian
			$this->noi_dung->AdvancedSearch->save(); // noi_dung
			$this->chuanloai_id->AdvancedSearch->save(); // chuanloai_id
			$this->thiet_bi_id->AdvancedSearch->save(); // thiet_bi_id
			$this->so_don_hang_id->AdvancedSearch->save(); // so_don_hang_id
			$this->ngay_hoan_thanh->AdvancedSearch->save(); // ngay_hoan_thanh
			$this->baoduong_dinhky->AdvancedSearch->save(); // baoduong_dinhky
		}
		return $where;
	}
	...
	{
		if ($this->nhan_vien_id->AdvancedSearch->issetSession())
			return TRUE;
		if ($this->ngay_sua_chua->AdvancedSearch->issetSession())
			return TRUE;
		if ($this->thoi_gian->AdvancedSearch->issetSession())
			return TRUE;
		if ($this->noi_dung->AdvancedSearch->issetSession())
			return TRUE;
		if ($this->chuanloai_id->AdvancedSearch->issetSession())
			return TRUE;
		if ($this->thiet_bi_id->AdvancedSearch->issetSession())
			return TRUE;
		if ($this->so_don_hang_id->AdvancedSearch->issetSession())
			return TRUE;
		if ($this->ngay_hoan_thanh->AdvancedSearch->issetSession())
			return TRUE;
		if ($this->baoduong_dinhky->AdvancedSearch->issetSession())
			return TRUE;
		return FALSE;
	}
	...
	protected function resetAdvancedSearchParms()
	{
		...
		$this->thoi_gian->AdvancedSearch->unsetSession();
		$this->noi_dung->AdvancedSearch->unsetSession();
	...
	protected function restoreSearchParms()
	{
		...
		$this->thoi_gian->AdvancedSearch->load();
		$this->noi_dung->AdvancedSearch->load();
	...
	protected function setupOtherOptions()
	{
		...
		$item->Body = "<a class=\"ew-save-filter\" data-form=\"fck_view_nhatkylistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
		$item->Visible = TRUE;
		$item = &$this->FilterOptions->add("deletefilter");
		$item->Body = "<a class=\"ew-delete-filter\" data-form=\"fck_view_nhatkylistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("DeleteFilter") . "</a>";
		$item->Visible = TRUE;
		...
		$options = &$this->OtherOptions;
			...
			foreach ($this->ListActions->Items as $listaction) {
				if ($listaction->Select == ACTION_MULTIPLE) {
					...
					$item->Body = "<a class=\"ew-action ew-list-action\" title=\"" . HtmlEncode($caption) . "\" data-caption=\"" . HtmlEncode($caption) . "\" href=\"#\" onclick=\"return ew.submitAction(event,jQuery.extend({f:document.fck_view_nhatkylist}," . $listaction->toJson(TRUE) . "));\">" . $icon . "</a>";
	...
	protected function loadSearchValues()
	{
		...
		// nhan_vien_id
		if (!$this->isAddOrEdit() && $this->nhan_vien_id->AdvancedSearch->get()) {
			$got = TRUE;
			if (($this->nhan_vien_id->AdvancedSearch->SearchValue != "" || $this->nhan_vien_id->AdvancedSearch->SearchValue2 != "") && $this->Command == "")
				$this->Command = "search";
		}
		...
		// thoi_gian
		if (!$this->isAddOrEdit() && $this->thoi_gian->AdvancedSearch->get()) {
			$got = TRUE;
			if (($this->thoi_gian->AdvancedSearch->SearchValue != "" || $this->thoi_gian->AdvancedSearch->SearchValue2 != "") && $this->Command == "")
				$this->Command = "search";
		}

		// noi_dung
		if (!$this->isAddOrEdit() && $this->noi_dung->AdvancedSearch->get()) {
			$got = TRUE;
			if (($this->noi_dung->AdvancedSearch->SearchValue != "" || $this->noi_dung->AdvancedSearch->SearchValue2 != "") && $this->Command == "")
				$this->Command = "search";
		}
		...
		// so_don_hang_id
		if (!$this->isAddOrEdit() && $this->so_don_hang_id->AdvancedSearch->get()) {
			$got = TRUE;
			if (($this->so_don_hang_id->AdvancedSearch->SearchValue != "" || $this->so_don_hang_id->AdvancedSearch->SearchValue2 != "") && $this->Command == "")
				$this->Command = "search";
		}
		...
		// baoduong_dinhky
		if (!$this->isAddOrEdit() && $this->baoduong_dinhky->AdvancedSearch->get()) {
			$got = TRUE;
			if (($this->baoduong_dinhky->AdvancedSearch->SearchValue != "" || $this->baoduong_dinhky->AdvancedSearch->SearchValue2 != "") && $this->Command == "")
				$this->Command = "search";
		}
		if (is_array($this->baoduong_dinhky->AdvancedSearch->SearchValue))
			$this->baoduong_dinhky->AdvancedSearch->SearchValue = implode(Config("MULTIPLE_OPTION_SEPARATOR"), $this->baoduong_dinhky->AdvancedSearch->SearchValue);
		if (is_array($this->baoduong_dinhky->AdvancedSearch->SearchValue2))
			$this->baoduong_dinhky->AdvancedSearch->SearchValue2 = implode(Config("MULTIPLE_OPTION_SEPARATOR"), $this->baoduong_dinhky->AdvancedSearch->SearchValue2);
		return $got;
	}
	...
	protected function newRow()
	{
		...
		$row['so_don_hang_id'] = NULL;
		$row['ngay_hoan_thanh'] = NULL;
		$row['baoduong_dinhky'] = NULL;
		return $row;
	}
	...
	public function renderRow()
	{
		...
		if ($this->RowType == ROWTYPE_VIEW) { // View row
			...
			$this->ngay_sua_chua->EditValue = HtmlEncode(FormatDateTime(UnFormatDateTime($this->ngay_sua_chua->AdvancedSearch->SearchValue, 0), 8));
			$this->ngay_sua_chua->PlaceHolder = RemoveHtml($this->ngay_sua_chua->caption());
			$this->ngay_sua_chua->EditAttrs["class"] = "form-control";
			$this->ngay_sua_chua->EditCustomAttributes = "";
			$this->ngay_sua_chua->EditValue2 = HtmlEncode(FormatDateTime(UnFormatDateTime($this->ngay_sua_chua->AdvancedSearch->SearchValue2, 0), 8));
			$this->ngay_sua_chua->PlaceHolder = RemoveHtml($this->ngay_sua_chua->caption());

			// thoi_gian
			$this->thoi_gian->EditAttrs["class"] = "form-control";
			$this->thoi_gian->EditCustomAttributes = "";
			$this->thoi_gian->EditValue = HtmlEncode($this->thoi_gian->AdvancedSearch->SearchValue);
			...
			$this->ngay_hoan_thanh->EditValue = HtmlEncode(FormatDateTime(UnFormatDateTime($this->ngay_hoan_thanh->AdvancedSearch->SearchValue, 0), 8));
	...
	protected function validateSearch()
	{
		...
		if (!Config("SERVER_VALIDATE"))
			return TRUE;
		if (!CheckDate($this->ngay_sua_chua->AdvancedSearch->SearchValue)) {
			AddMessage($SearchError, $this->ngay_sua_chua->errorMessage());
		}
		if (!CheckDate($this->ngay_sua_chua->AdvancedSearch->SearchValue2)) {
			AddMessage($SearchError, $this->ngay_sua_chua->errorMessage());
		}
	...
	protected function setupSearchOptions()
	{
		...
		$item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" href=\"#\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-toggle=\"button\" data-form=\"fck_view_nhatkylistsrch\" aria-pressed=\"" . ($searchToggleClass == " active" ? "true" : "false") . "\">" . $Language->phrase("SearchLink") . "</a>";
		$item->Visible = TRUE;
