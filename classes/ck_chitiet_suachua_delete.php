 ...
 * Page class
 */
class ck_chitiet_suachua_delete extends ck_chitiet_suachua
{
	...
	// Page object name
	public $PageObjName = "ck_chitiet_suachua_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("ck_chitiet_suachualist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("ck_chitiet_suachualist.php"); // Return to list
			}
		}
	}
