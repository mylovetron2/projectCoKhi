 ...
 * Page class
 */
class ck_chitiet_suachua_list extends ck_chitiet_suachua
{
	...
	// Page object name
	public $PageObjName = "ck_chitiet_suachua_list";

	// Grid form hidden field names
	public $FormName = "fck_chitiet_suachualist";
	...
	public function __construct()
	{
		...
		$this->MultiDeleteUrl = "ck_chitiet_suachuadelete.php";
		$this->MultiUpdateUrl = "ck_chitiet_suachuaupdate.php";
		...
		$this->FilterOptions->TagClassName = "ew-filter-option fck_chitiet_suachualistsrch";
	...
	protected function setupOtherOptions()
	{
		...
		$item->Body = "<a class=\"ew-save-filter\" data-form=\"fck_chitiet_suachualistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
		$item->Visible = FALSE;
		$item = &$this->FilterOptions->add("deletefilter");
		$item->Body = "<a class=\"ew-delete-filter\" data-form=\"fck_chitiet_suachualistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("DeleteFilter") . "</a>";
		$item->Visible = FALSE;
		...
		$options = &$this->OtherOptions;
			...
			foreach ($this->ListActions->Items as $listaction) {
				if ($listaction->Select == ACTION_MULTIPLE) {
					...
					$item->Body = "<a class=\"ew-action ew-list-action\" title=\"" . HtmlEncode($caption) . "\" data-caption=\"" . HtmlEncode($caption) . "\" href=\"#\" onclick=\"return ew.submitAction(event,jQuery.extend({f:document.fck_chitiet_suachualist}," . $listaction->toJson(TRUE) . "));\">" . $icon . "</a>";
	...
	function ListOptions_Rendered() {
		...
		if($this->tennhanvien->ViewValue!= CurrentUserName())
