...
class view1 extends DbTable
{
	...
	public function __construct()
	{
		...
		// ngay_sua_chua
		$this->ngay_sua_chua = new DbField('view1', 'view1', 'x_ngay_sua_chua', 'ngay_sua_chua', '`ngay_sua_chua`', CastDateFieldForLike("`ngay_sua_chua`", 7, "DB"), 133, 10, 7, FALSE, '`ngay_sua_chua`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// search
		$this->search = new DbField('view1', 'view1', 'x_search', 'search', '\'\'', '\'\'', 201, 65530, -1, FALSE, '\'\'', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		$this->search->IsCustom = TRUE; // Custom field
		$this->search->Required = TRUE; // Required field
		$this->search->Sortable = TRUE; // Allow sort
		$this->search->UsePleaseSelect = TRUE; // Use PleaseSelect by default
		$this->search->PleaseSelectText = $Language->phrase("PleaseSelect"); // "PleaseSelect" text
		$this->search->Lookup = new Lookup('search', 'view1', FALSE, '', ["","","",""], [], [], [], [], [], [], '', '');
		$this->search->OptionCount = 2;
	...
	{
		return ($this->SqlSelect != "") ? $this->SqlSelect : "SELECT *, '' AS `search` FROM " . $this->getSqlFrom();
	}
	...
	protected function loadDbValues(&$rs)
	{
		...
		$this->search->DbValue = $row['search'];
	}
	...
	public function loadListRowValues(&$rs)
	{
		...
		$this->search->setDbValue($rs->fields('search'));
	}
