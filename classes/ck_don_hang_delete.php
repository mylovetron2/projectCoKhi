 ...
 * Page class
 */
class ck_don_hang_delete extends ck_don_hang
{
	...
	// Page object name
	public $PageObjName = "ck_don_hang_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("ck_don_hanglist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("ck_don_hanglist.php"); // Return to list
			}
		}
	}
