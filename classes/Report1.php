...
class Report1 extends ReportTable
{
	...
	public function __construct()
	{
		...
		// nhan_vien_id
		$this->nhan_vien_id = new ReportField('Report1', 'Report1', 'x_nhan_vien_id', 'nhan_vien_id', '`nhan_vien_id`', '`nhan_vien_id`', 3, 11, -1, FALSE, '`nhan_vien_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		$this->nhan_vien_id->Lookup = new Lookup('nhan_vien_id', 'ck_view_nhan_vien_ck', FALSE, 'nhan_vien_id', ["danh_so","ten_nhan_vien","",""], [], [], [], [], [], [], '', '');
		...
		// ngay_sua_chua
		$this->ngay_sua_chua = new ReportField('Report1', 'Report1', 'x_ngay_sua_chua', 'ngay_sua_chua', '`ngay_sua_chua`', CastDateFieldForLike("`ngay_sua_chua`", 0, "DB"), 133, 10, 0, FALSE, '`ngay_sua_chua`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// thoi_gian
		$this->thoi_gian = new ReportField('Report1', 'Report1', 'x_thoi_gian', 'thoi_gian', '`thoi_gian`', '`thoi_gian`', 3, 11, -1, FALSE, '`thoi_gian`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// noi_dung
		$this->noi_dung = new ReportField('Report1', 'Report1', 'x_noi_dung', 'noi_dung', '`noi_dung`', '`noi_dung`', 201, 1000, -1, FALSE, '`noi_dung`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->noi_dung->Sortable = TRUE; // Allow sort
		$this->noi_dung->SourceTableVar = 'ck_view_nhatky';
		$this->fields['noi_dung'] = &$this->noi_dung;

		// chuanloai_id
		$this->chuanloai_id = new ReportField('Report1', 'Report1', 'x_chuanloai_id', 'chuanloai_id', '`chuanloai_id`', '`chuanloai_id`', 3, 11, -1, FALSE, '`chuanloai_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// thiet_bi_id
		$this->thiet_bi_id = new ReportField('Report1', 'Report1', 'x_thiet_bi_id', 'thiet_bi_id', '`thiet_bi_id`', '`thiet_bi_id`', 3, 11, -1, FALSE, '`thiet_bi_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// so_don_hang_id
		$this->so_don_hang_id = new ReportField('Report1', 'Report1', 'x_so_don_hang_id', 'so_don_hang_id', '`so_don_hang_id`', '`so_don_hang_id`', 200, 110, -1, FALSE, '`so_don_hang_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ngay_hoan_thanh
		$this->ngay_hoan_thanh = new ReportField('Report1', 'Report1', 'x_ngay_hoan_thanh', 'ngay_hoan_thanh', '`ngay_hoan_thanh`', CastDateFieldForLike("`ngay_hoan_thanh`", 0, "DB"), 133, 10, 0, FALSE, '`ngay_hoan_thanh`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// baoduong_dinhky
		$this->baoduong_dinhky = new ReportField('Report1', 'Report1', 'x_baoduong_dinhky', 'baoduong_dinhky', '`baoduong_dinhky`', '`baoduong_dinhky`', 16, 1, -1, FALSE, '`baoduong_dinhky`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'CHECKBOX');
		$this->baoduong_dinhky->Sortable = TRUE; // Allow sort
		$this->baoduong_dinhky->DataType = DATATYPE_BOOLEAN;
		$this->baoduong_dinhky->Lookup = new Lookup('baoduong_dinhky', 'Report1', FALSE, '', ["","","",""], [], [], [], [], [], [], '', '');
