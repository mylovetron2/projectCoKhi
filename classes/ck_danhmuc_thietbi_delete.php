 ...
 * Page class
 */
class ck_danhmuc_thietbi_delete extends ck_danhmuc_thietbi
{
	...
	// Page object name
	public $PageObjName = "ck_danhmuc_thietbi_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("ck_danhmuc_thietbilist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("ck_danhmuc_thietbilist.php"); // Return to list
			}
		}
	}
