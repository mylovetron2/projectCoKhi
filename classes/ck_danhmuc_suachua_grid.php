 ...
 * Page class
 */
class ck_danhmuc_suachua_grid extends ck_danhmuc_suachua
{
	...
	// Page object name
	public $PageObjName = "ck_danhmuc_suachua_grid";

	// Grid form hidden field names
	public $FormName = "fck_danhmuc_suachuagrid";
	...
	public function __construct()
	{
		...
		$this->AddUrl = "ck_danhmuc_suachuaadd.php";
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	{
		$this->thoi_gian_sua_chua->FormValue = ""; // Clear form value
		...
		for ($rowindex = 1; $rowindex <= $rowcnt; $rowindex++) {
			...
			if (!$this->emptyRow()) {
				...
				if ($gridInsert) {
					...
					$key .= $this->sua_chua_id->CurrentValue;
	...
	{
		global $CurrentForm;
		if ($CurrentForm->hasValue("x_chuanloai_id") && $CurrentForm->hasValue("o_chuanloai_id") && $this->chuanloai_id->CurrentValue != $this->chuanloai_id->OldValue)
			return FALSE;
		if ($CurrentForm->hasValue("x_thiet_bi_id") && $CurrentForm->hasValue("o_thiet_bi_id") && $this->thiet_bi_id->CurrentValue != $this->thiet_bi_id->OldValue)
			return FALSE;
		if ($CurrentForm->hasValue("x_ngay_sua_chua") && $CurrentForm->hasValue("o_ngay_sua_chua") && $this->ngay_sua_chua->CurrentValue != $this->ngay_sua_chua->OldValue)
			return FALSE;
		if ($CurrentForm->hasValue("x_noi_dung_sua_chua") && $CurrentForm->hasValue("o_noi_dung_sua_chua") && $this->noi_dung_sua_chua->CurrentValue != $this->noi_dung_sua_chua->OldValue)
			return FALSE;
		if ($CurrentForm->hasValue("x_thoi_gian_sua_chua") && $CurrentForm->hasValue("o_thoi_gian_sua_chua") && $this->thoi_gian_sua_chua->CurrentValue != $this->thoi_gian_sua_chua->OldValue)
			return FALSE;
		if ($CurrentForm->hasValue("x_nguoi_nhap_lieu") && $CurrentForm->hasValue("o_nguoi_nhap_lieu") && $this->nguoi_nhap_lieu->CurrentValue != $this->nguoi_nhap_lieu->OldValue)
			return FALSE;
		if ($CurrentForm->hasValue("x_dich_vu") && $CurrentForm->hasValue("o_dich_vu") && ConvertToBool($this->dich_vu->CurrentValue) != ConvertToBool($this->dich_vu->OldValue))
			return FALSE;
		if ($CurrentForm->hasValue("x_hoan_thanh") && $CurrentForm->hasValue("o_hoan_thanh") && ConvertToBool($this->hoan_thanh->CurrentValue) != ConvertToBool($this->hoan_thanh->OldValue))
			return FALSE;
		if ($CurrentForm->hasValue("x_id_don_hang") && $CurrentForm->hasValue("o_id_don_hang") && $this->id_don_hang->CurrentValue != $this->id_don_hang->OldValue)
			return FALSE;
		if ($CurrentForm->hasValue("x_ngay_hoan_thanh") && $CurrentForm->hasValue("o_ngay_hoan_thanh") && $this->ngay_hoan_thanh->CurrentValue != $this->ngay_hoan_thanh->OldValue)
			return FALSE;
		return TRUE;
	}
	...
	public function renderListOptions()
	{
		...
		if ($this->CurrentMode == "edit" && is_numeric($this->RowIndex) && $this->RowAction != "delete") {
			$this->MultiSelectKey .= "<input type=\"hidden\" name=\"" . $keyName . "\" id=\"" . $keyName . "\" value=\"" . $this->sua_chua_id->CurrentValue . "\">";
		}
	...
	protected function loadDefaultValues()
	{
		...
		$this->sua_chua_id->OldValue = $this->sua_chua_id->CurrentValue;
		$this->chuanloai_id->CurrentValue = NULL;
		$this->chuanloai_id->OldValue = $this->chuanloai_id->CurrentValue;
		$this->thiet_bi_id->CurrentValue = NULL;
		$this->thiet_bi_id->OldValue = $this->thiet_bi_id->CurrentValue;
		$this->ngay_sua_chua->CurrentValue = NULL;
		$this->ngay_sua_chua->OldValue = $this->ngay_sua_chua->CurrentValue;
		...
		$this->nguoi_nhap_lieu->OldValue = $this->nguoi_nhap_lieu->CurrentValue;
		$this->dich_vu->CurrentValue = NULL;
		$this->dich_vu->OldValue = $this->dich_vu->CurrentValue;
		$this->hoan_thanh->CurrentValue = NULL;
		$this->hoan_thanh->OldValue = $this->hoan_thanh->CurrentValue;
		$this->ghi_chu->CurrentValue = NULL;
		$this->ghi_chu->OldValue = $this->ghi_chu->CurrentValue;
		$this->id_don_hang->CurrentValue = NULL;
		$this->id_don_hang->OldValue = $this->id_don_hang->CurrentValue;
		$this->ngay_hoan_thanh->CurrentValue = NULL;
		$this->ngay_hoan_thanh->OldValue = $this->ngay_hoan_thanh->CurrentValue;
	}
	...
	protected function loadFormValues()
	{
		...
		if ($CurrentForm->hasValue("o_chuanloai_id"))
			$this->chuanloai_id->setOldValue($CurrentForm->getValue("o_chuanloai_id"));
		...
		if ($CurrentForm->hasValue("o_thiet_bi_id"))
			$this->thiet_bi_id->setOldValue($CurrentForm->getValue("o_thiet_bi_id"));
		...
		if ($CurrentForm->hasValue("o_ngay_sua_chua"))
			$this->ngay_sua_chua->setOldValue($CurrentForm->getValue("o_ngay_sua_chua"));
		...
		if ($CurrentForm->hasValue("o_noi_dung_sua_chua"))
			$this->noi_dung_sua_chua->setOldValue($CurrentForm->getValue("o_noi_dung_sua_chua"));
		...
		if ($CurrentForm->hasValue("o_thoi_gian_sua_chua"))
			$this->thoi_gian_sua_chua->setOldValue($CurrentForm->getValue("o_thoi_gian_sua_chua"));
		...
		if ($CurrentForm->hasValue("o_nguoi_nhap_lieu"))
			$this->nguoi_nhap_lieu->setOldValue($CurrentForm->getValue("o_nguoi_nhap_lieu"));
		...
		if ($CurrentForm->hasValue("o_dich_vu"))
			$this->dich_vu->setOldValue($CurrentForm->getValue("o_dich_vu"));
		...
		if ($CurrentForm->hasValue("o_hoan_thanh"))
			$this->hoan_thanh->setOldValue($CurrentForm->getValue("o_hoan_thanh"));
		...
		if ($CurrentForm->hasValue("o_id_don_hang"))
			$this->id_don_hang->setOldValue($CurrentForm->getValue("o_id_don_hang"));
		...
		if ($CurrentForm->hasValue("o_ngay_hoan_thanh"))
			$this->ngay_hoan_thanh->setOldValue($CurrentForm->getValue("o_ngay_hoan_thanh"));
		...
		if (!$this->sua_chua_id->IsDetailKey && !$this->isGridAdd() && !$this->isAdd())
	...
	protected function newRow()
	{
		...
		$row = [];
		$row['sua_chua_id'] = $this->sua_chua_id->CurrentValue;
		$row['chuanloai_id'] = $this->chuanloai_id->CurrentValue;
		...
		$row['id_don_hang'] = $this->id_don_hang->CurrentValue;
		$row['ngay_hoan_thanh'] = $this->ngay_hoan_thanh->CurrentValue;
		return $row;
	}
	...
	protected function loadOldRecord()
	{
		...
		if ($cnt >= 1) {
			if (strval($keys[0]) != "")
				$this->sua_chua_id->OldValue = strval($keys[0]); // sua_chua_id
			else
				$validKey = FALSE;
		} else {
			$validKey = FALSE;
	...
	public function renderRow()
	{
		...
		if ($this->RowType == ROWTYPE_VIEW) { // View row
			...
			if (strval($this->thoi_gian_sua_chua->EditValue) != "" && is_numeric($this->thoi_gian_sua_chua->EditValue)) {
				...
				$this->thoi_gian_sua_chua->OldValue = $this->thoi_gian_sua_chua->EditValue;
			}
	...
	protected function addRow($rsold = NULL)
	{
		...
		// Check referential integrity for master table 'ck_danhmuc_suachua'
		$validMasterRecord = TRUE;
		$masterFilter = $this->sqlMasterFilter_ck_don_hang();
		if (strval($this->id_don_hang->CurrentValue) != "") {
			$masterFilter = str_replace("@id@", AdjustSql($this->id_don_hang->CurrentValue, "DB"), $masterFilter);
		} else {
			$validMasterRecord = FALSE;
		}
		if ($validMasterRecord) {
		...
		// chuanloai_id
		$this->chuanloai_id->setDbValueDef($rsnew, $this->chuanloai_id->CurrentValue, NULL, FALSE);

		// thiet_bi_id
		$this->thiet_bi_id->setDbValueDef($rsnew, $this->thiet_bi_id->CurrentValue, 0, FALSE);
		...
		// thoi_gian_sua_chua
		$this->thoi_gian_sua_chua->setDbValueDef($rsnew, $this->thoi_gian_sua_chua->CurrentValue, NULL, FALSE);
		...
		if ($tmpBool != "1" && $tmpBool != "0")
			$tmpBool = !empty($tmpBool) ? "1" : "0";
		$this->hoan_thanh->setDbValueDef($rsnew, $tmpBool, 0, strval($this->hoan_thanh->CurrentValue) == "");

		// id_don_hang
		$this->id_don_hang->setDbValueDef($rsnew, $this->id_don_hang->CurrentValue, 0, FALSE);

		// ngay_hoan_thanh
		$this->ngay_hoan_thanh->setDbValueDef($rsnew, UnFormatDateTime($this->ngay_hoan_thanh->CurrentValue, 7), NULL, FALSE);
	...
	protected function setupMasterParms()
	{
		...
		if ($masterTblVar == "ck_don_hang") {
			$this->id_don_hang->Visible = FALSE;
			if ($GLOBALS["ck_don_hang"]->EventCancelled)
