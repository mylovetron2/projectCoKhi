...
class index
{
	...
	public function run()
	{
		...
		if ($Security->allowList(CurrentProjectID() . 'ck_danhmuc_thietbi'))
			$this->terminate("ck_danhmuc_thietbilist.php"); // Exit and go to default page
		if ($Security->allowList(CurrentProjectID() . 'ck_chungloai_thietbi'))
		...
		if ($Security->allowList(CurrentProjectID() . 'nhan_vien'))
		...
		if ($Security->allowList(CurrentProjectID() . 'ck_view_nhatky_thietbi'))
			$this->terminate("ck_view_nhatky_thietbilist.php");
		if ($Security->allowList(CurrentProjectID() . 'ck_don_hang'))
			$this->terminate("ck_don_hanglist.php");
		if ($Security->allowList(CurrentProjectID() . 'view1'))
			$this->terminate("view1list.php");
		if ($Security->allowList(CurrentProjectID() . 'ck_view_nhom_nhan_vien'))
			$this->terminate("ck_view_nhom_nhan_vienlist.php");
		if ($Security->isLoggedIn()) {
