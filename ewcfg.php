...
// Project
define(PROJECT_NAMESPACE . "PROJECT_NAME", "projectCoKhi"); // Project name
...
$CONFIG = [
	...
	"RANDOM_KEY" => 'LpU3NqW1pq88IzlB', // Random key for encryption
	"ENCRYPTION_KEY" => '', // Encryption key for data protection
	"PROJECT_STYLESHEET_FILENAME" => "css/projectCoKhi.css", // Project stylesheet file name
	...
	"PROJECT_ID" => "{5DCEF576-624A-4686-A415-DE69CC04A397}", // Project ID (GUID)
	...
	// User table filters
	"USER_TABLE_DBID" => "diavatly",
	"USER_TABLE" => "`nhan_vien`",
	"USER_NAME_FILTER" => "(`username` = '%u')",
	"USER_ID_FILTER" => "(`nhan_vien_id` = %u)",
	"USER_EMAIL_FILTER" => "",
